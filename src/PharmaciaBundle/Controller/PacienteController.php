...
use PharmaciaBundle\Entity\Paciente;
...
class PacienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pacientes = $em->getRepository('PharmaciaBundle:Paciente')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('PharmaciaBundle\Form\PacienteType', $paciente);
    ...
    {
        $deleteForm = $this->createDeleteForm($paciente);
        $editForm = $this->createForm('PharmaciaBundle\Form\PacienteType', $paciente);
